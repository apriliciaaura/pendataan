    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card card-outline card-primary">
          ...
          <div class="card-body">
          <form action="{{ route('galeri.store') }}" method="POST" role="form" enctype="multipart/form-data" id="quickForm">
              @csrf
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        {!! csrf_field() !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="" name="keterangan" id="">
                                    </div>
                            <div class="form-group">
